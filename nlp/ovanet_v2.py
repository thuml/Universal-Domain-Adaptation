...
def main(args, save_config):
    ...
    ## LOGGINGS ##
    log_dir = f'{args.log.output_dir}/{args.dataset.name}/ovanet_v2/common-class-{args.dataset.num_common_class}/{args.train.seed}/{args.train.lr}'
    ...
    ## OPTIMIZER & SCHEDULER ##
    base_optimizer = optim.AdamW(model.model.parameters(), lr=args.train.lr)
    cls_optimizer = optim.AdamW(list(model.C1.parameters())+list(model.C2.parameters()), lr=0.01)
