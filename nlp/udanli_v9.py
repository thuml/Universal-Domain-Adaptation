...
def main(args, save_config):
    ...
    ## LOGGINGS ##
    log_dir = f'{args.log.output_dir}/{args.dataset.name}/udanli_v9/udanli-{args.train.adv_weight}-{args.num_nli_sample}/{split}/common-class-{args.dataset.num_common_class}/{args.train.seed}/{args.train.lr}'
