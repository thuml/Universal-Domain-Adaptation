...
DATASET_PATH = '/home/heyjoonkim/data/datasets/trec'
SPLITS = ['train', 'validation', 'test']
# FINE_LABEL = 'label-fine'
# COARSE_LABEL = 'label-coarse'
...
def main():
    ...
    split_data = source_data.train_test_split(test_size=0.3)
    train_source_data, eval_source_data = split_data['train'], split_data['test']

    dataset_path = os.path.join(output_dir, f'source_train.jsonl')
    train_source_data.to_json(dataset_path)


    dataset_path = os.path.join(output_dir, f'source_val.jsonl')
    eval_source_data.to_json(dataset_path)
    ...
    dataset_path = os.path.join(output_dir, f'target_test.jsonl')
    target_data.to_json(dataset_path)
    ...
    dataset_path = os.path.join(output_dir, f'source_test.jsonl')
