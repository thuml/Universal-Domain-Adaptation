...
DATASET_PATH = '/home/heyjoonkim/data/datasets/clinc'
...
def main():
    ...
    with open(log_path, 'w') as f:
        f.write(f'# Common Class         : {num_source_private_classes} : {common_classes}\n')
        f.write(f'# Source Private Class : {num_target_private_classes} : {source_private_classes}\n')
        f.write(f'# Target Private Class : {num_common_class} : {target_private_classes}\n')
