...
def main(args, save_config):
    ...
    if 'source_domain' in args.dataset:
        ...
        mlm_dir = f'{args.log.output_dir}/{args.dataset.name}/udalm/{source_domain}-{target_domain}/mlm/common-class-{args.dataset.num_common_class}/{args.train.seed}/0.0001'
        log_dir = f'{args.log.output_dir}/{args.dataset.name}/udalm/{source_domain}-{target_domain}/common-class-{args.dataset.num_common_class}/{args.train.seed}/{args.train.lr}'
